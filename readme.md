...
## Installation
> [!IMPORTANT]
> Industrial Park is compatible with **Windows** only (Windows 10 Version 1607 or later), and requires [.NET Desktop Runtime 10.x](https://dotnet.microsoft.com/en-us/download/dotnet/10.0) and Direct3D 11 support.
